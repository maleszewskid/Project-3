...
const height1 = (height[0]*12)+height[1]
...
const diabetic = "Blood Glucose: " + bloodSugar + " mg/dL (View Chart 3) | Weight: " + weight + " lbs | BMI: " + (weight * 703) / (height1 * height1) + " (View Chart 4)"
const UserPDF = () => {
  return(
  <Document>
    <Page>
